            ...
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/mokone-september/Kasi-Pizza" target="_blank" rel="noreferrer">
                 ...
                 <a href="https://kasi-pizza.vercel.app/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a> 
              </div>
            </header>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                 <a href="https://medium.com/@mokoneseptember" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a> 
              </div>
            </header>
            <div className="body">
              <h3>Medium</h3>
              <p>
              Medium is a blogging platform that allows users to share their thoughts, stories, and ideas with a global audience. It provides a clean and minimalist interface for writing and reading articles, making it easy for anyone to publish content and engage with readers.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
